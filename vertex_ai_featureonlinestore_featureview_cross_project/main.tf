...
resource "google_vertex_ai_feature_online_store" "featureonlinestore" {
  name     = "example_cross_project_featureview-${local.name_suffix}"
  project  = google_project.project.project_id
  labels = {
    foo = "bar"
  }
...
resource "google_bigquery_dataset" "sample_dataset" {
  dataset_id                  = "example_cross_project_featureview-${local.name_suffix}"
  friendly_name               = "test"
...
resource "google_bigquery_table" "sample_table" {
  ...
  dataset_id = google_bigquery_dataset.sample_dataset.dataset_id
  table_id   = "example_cross_project_featureview-${local.name_suffix}"
